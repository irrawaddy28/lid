...
$avconv_opts[3] = "10";		   # skip segment (in seconds) at the beginnig of input file
...
foreach (@in_files) {
	...
	# /usr/bin/avconv  -i  input.mp3  -acodec   pcm_s16le  -ar   16000  -ac   1  -ss   10  output.wav	2>/dev/null	
	system("$avconvcli");	
